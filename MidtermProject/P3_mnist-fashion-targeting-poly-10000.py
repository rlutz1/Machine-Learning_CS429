...
MNIST_DATA_PATH = os.path.join(os.getcwd(), "data", "P3", "mnist-fashion") # directory to write data to for collection
INITIAL_FIT_TIMES = "initial-fit-times_poly-10000.csv" # for the initial fit times of everything in the pipeline
TEST_AND_TRAIN_ACC = "test-train-acc_poly-10000.csv" # for the accuracy of final SVC on test, then train data
FINAL_TIMES = "final-times_poly-10000.csv" # for the final times, that includes final transforms of test data

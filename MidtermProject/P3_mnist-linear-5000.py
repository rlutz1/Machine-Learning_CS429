...
INITIAL_FIT_TIMES = "initial-fit-times_linear-5000.csv" # for the initial fit times of everything in the pipeline
TEST_AND_TRAIN_ACC = "test-train-acc_linear-5000.csv" # for the accuracy of final SVC on test, then train data
FINAL_TIMES = "final-times_linear-5000.csv" # for the final times, that includes final transforms of test data
